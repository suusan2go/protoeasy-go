...
Let's compile these with go, grpc, and [grpc-gateway](https://github.com/grpc-ecosystem/grpc-gateway), and do them all now
...
* https://github.com/google/googleapis, done using https://go.pedge.io/pb. google/api/annotations.proto and google/api/http.proto are done using https://github.com/grpc-ecosystem/grpc-gateway/tree/master/third_party/googleapis/google/api.
