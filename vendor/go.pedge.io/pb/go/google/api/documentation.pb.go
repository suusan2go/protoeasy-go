...
func (*Documentation) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*DocumentationRule) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (*Page) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{2} }
...
func init() { proto.RegisterFile("google/api/documentation.proto", fileDescriptor9) }
