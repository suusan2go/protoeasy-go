...
func (*Http) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*HttpRule) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (*CustomHttpPattern) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{2} }
...
func init() { proto.RegisterFile("google/api/http.proto", fileDescriptor11) }
