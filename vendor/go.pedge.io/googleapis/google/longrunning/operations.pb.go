...
import google_rpc "go.pedge.io/googleapis/google/rpc"
...
func _Operations_GetOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
...
func _Operations_ListOperations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
...
func _Operations_CancelOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
...
func _Operations_DeleteOperation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
